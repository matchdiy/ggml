...
void ggml_cuda_flash_attn_ext_vec_f32_case_impl(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
    constexpr int nwarps = D/WARP_SIZE;
...
void ggml_cuda_flash_attn_ext_vec_f32_case(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
...
#define DECL_FATTN_VEC_F32_CASE(D, type_K, type_V)                          \
    ...
    <D, type_K, type_V>(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) \
