...
#define GGML_CUDA_CC_RTX5000         1200
...
#if !defined(GGML_USE_HIP) && CUDART_VERSION >= 11070
#    define GGML_CUDA_USE_CUB
#endif  // !defined(GGML_USE_HIP) && CUDART_VERSION >= 11070
...
struct ggml_backend_ac4k_context {
    int device;
    std::string name;
    ...
    explicit ggml_backend_ac4k_context(int device) :
        device(device),
        name(GGML_CUDA_NAME + std::to_string(device)) {
    }

    ~ggml_backend_ac4k_context();
