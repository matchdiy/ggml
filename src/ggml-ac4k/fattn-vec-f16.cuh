...
void ggml_cuda_flash_attn_ext_vec_f16_case_impl(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
    constexpr int nwarps = D/WARP_SIZE;
...
void ggml_cuda_flash_attn_ext_vec_f16_case(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
