...
void ggml_cuda_flash_attn_ext_mma_f16_case(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
...
#define DECL_FATTN_MMA_F16_CASE(DKQ, DV, ncols1, ncols2)                          \
    ...
    <DKQ, DV, ncols1, ncols2>(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) \
